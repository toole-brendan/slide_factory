...
def paint_cost_matrix(out: list[str], ids: ShapeIds) -> None:
    ...
    """
    out.append(table(ids.next(), "Table 8", *COST_MATRIX_TABLE.box.emu(),
...
def paint_cost_category_legend(out: list[str], ids: ShapeIds) -> None:
    ...
    out.append(text_box(ids.next(), "TextBox 46", IN(9.1), IN(1.164), IN(0.8), _LEGEND_H, [paragraph([run("Price", size=PT(8), color=BLACK, font=FONT), line_break(), run("Components", size=PT(8), color=BLACK, font=FONT)], line_spacing=100000)], fill=None, line_color="none", anchor="ctr", wrap="none"))   # 000000 black
    ...
    out.append(text_box(ids.next(), "TextBox 48", IN(10.139), IN(1.164), IN(0.9), _LEGEND_H, [paragraph([run("Shoreside ", size=PT(8), color=BLACK, font=FONT), line_break(), run("variable costs", size=PT(8), color=BLACK, font=FONT)], line_spacing=100000)], fill=None, line_color="none", anchor="ctr", wrap="none"))   # 000000 black
    out.append(text_box(ids.next(), "TextBox 51", IN(11.278), IN(1.165), IN(0.9), _LEGEND_H, [paragraph([run("Vessel-related ", size=PT(8), color=BLACK, font=FONT), line_break(), run("variable costs", size=PT(8), color=BLACK, font=FONT)], line_spacing=100000)], fill=None, line_color="none", anchor="ctr", wrap="none"))   # 000000 black
    out.append(text_box(ids.next(), "TextBox 53", IN(12.417), IN(1.164), IN(0.4), _LEGEND_H, [paragraph([run("Opex", size=PT(8), color=BLACK, font=FONT)], line_spacing=100000)], fill=None, line_color="none", anchor="ctr", wrap="none"))   # 000000 black
