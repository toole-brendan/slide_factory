...
TEACHING_METADATA = {
    ...
    "teaches": [
        "native combo_chart dual-axis rebuild with source-aligned hidden secondary category axis",
    ...
    "source_chart_assets_used_for_transcription": ("status_quo_outlook_offshore_2.xml", "status_quo_outlook_offshore_2.xlsb"),
